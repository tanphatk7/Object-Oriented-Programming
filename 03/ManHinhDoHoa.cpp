...
std::vector<DaGiac*> ManHinhDoHoa::danhSachDaGiac;
...
void ManHinhDoHoa::renderScreen() {
    ...
    for (int i = 0; i < danhSachDaGiac.size(); i++) {
        danhSachDaGiac[i]->VeDaGiac();
    }
...
void ManHinhDoHoa::ThemDaGiac(DaGiac* dg) {
    danhSachDaGiac.push_back(dg);
}
...
void ManHinhDoHoa::HienThi(int argc, char** argv) {
    ...
    glutCreateWindow("Ve He Truc Toa Do va Da Giac");
