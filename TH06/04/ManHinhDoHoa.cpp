...
std::vector<Circle*> ManHinhDoHoa::danhSachHinhTron;
...
void ManHinhDoHoa::renderScreen() {
    ...
    for (int i = 0; i < danhSachHinhTron.size(); i++) {
        danhSachHinhTron[i]->VeHinhTron();
    }
...
void ManHinhDoHoa::ThemHinhTron(Circle *c) {
    danhSachHinhTron.push_back(c);
}
...
void ManHinhDoHoa::HienThi(int argc, char** argv) {
    ...
    glutCreateWindow("Ve He Truc Toa Do va Hinh Tron");
